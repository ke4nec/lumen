...
> 状态：P0 已完成并冻结 before 基线；P1 待实施。CPU 尚未迁移，性能收益尚未验证。
...
按第 6.2 节分别保存每次输出。P0 已增加 `lumen-alpha-bench`、`lumen-alpha-gallery` 和三组/配对采样驱动；具体场景、参数、计时范围见 [统一命令表 §4](build-commands.md#4-预乘-alpha-迁移的固定测量入口p02026-09-20)，运行记录见 [P0](perf-baselines/premultiplied-alpha-2026-09-20/P0.md)。
